;(function($, w) {
    ...
    $('#widget-home').live('pageinit', function() {
        ...
        var do_share_links = function() {
            ...
            facebook.attr('href', 'https://www.facebook.com/dialog/feed?app_id=232297670169625&display=page&link=https://www.epa.gov/wastes/conserve/tools/iwarm/widgets/&picture=http://epa.gov/wastes/conserve/tools/iwarm/widgets/images/iWarm_logo.png&name=How Much Energy Can You Save by Recycling?&redirect_uri=http://epa.gov/wastes/conserve/tools/iwarm/widgets/&description=%20&caption='+encodeURIComponent(get_share_text(false)));
        };
